...
### Clé du Wi-Fi des enfants

En posture passerelle, le boîtier diffuse son propre Wi-Fi pour les enfants. Sa clé se
change dans **Gestion → Wi-Fi des enfants** : saisir une nouvelle clé (ou en générer une
lisible), puis valider. Utile si la clé a circulé au-delà de la maison, ou si elle a été
oubliée — elle n'est jamais réaffichée, on ne peut que la remplacer.

Le changement déconnecte **tous** les appareils des enfants : ils ne reviendront qu'une
fois la nouvelle clé saisie sur chacun. Le Wi-Fi de la box, celui des parents, n'est pas
touché.
...
d'une journée précise : **Profils → Modifier → Voir le détail d'une journée**. Mot de
