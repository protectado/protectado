...
### Clave del Wi-Fi de los menores

En modo pasarela el equipo emite su propio Wi-Fi para los menores. Su clave se cambia en
**Gestión → Wi-Fi de los menores**: escribe una clave nueva (o genera una legible) y
confirma. Sirve si la clave ha circulado fuera de casa, o si se ha olvidado: no se vuelve
a mostrar nunca, solo se puede sustituir.

El cambio desconecta **todos** los aparatos de los menores: vuelven solo cuando se
introduce la nueva clave en cada uno. El Wi-Fi del router, el de los adultos, no se toca.
...
un día concreto: **Perfiles → Modificar → Ver el detalle de un día**. Se pide de nuevo la
