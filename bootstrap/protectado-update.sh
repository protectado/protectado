...
as_user git fetch origin "+refs/heads/$BRANCH:refs/remotes/origin/$BRANCH" --quiet 2>&1 || {
...
for unit in protectado-update.service protectado-update.path protectado-runner.service; do
